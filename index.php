<?php
// You can replace this static array with a database fetch later
$menu = [
...
<section class="hero text-center">
    <div>
        ...
        <p class="lead">Order your favorite meals with one click</p>
...
<section id="menu" class="container py-5">
    <h2 class="text-center mb-4 fw-bold text-danger">Our Menu</h2>
    <div class="row g-4">
...
<section class="bg-light py-5">
    <div class="container">
        <h2 class="text-center text-danger mb-4 fw-bold">Place Your Order</h2>
        <form class="row g-3 justify-content-center">
            ...
            <div class="col-md-8">
                <textarea class="form-control" rows="3" placeholder="Your Order Details"></textarea>
            </div>
